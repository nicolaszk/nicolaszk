...
🌱 I'm learning **Java** for software development and doing academic research on **machine learning** using Python.  

🎓 Atualmente curso **Ciência da Computação na PUCRS**.  
🎵 Gosto de tocar piano e programar.  
🌱 Atualmente estou aprendendo **Java** para desenvolvimento de software e realizando pesquisa acadêmica em **machine learning** com Python.
